...
<script>
// 분쇄도, 용량 설정
function selectCoffeeCapacity(capacity) {
	...
	window.onload = function() {
			selectCoffeeHardgroveAndCapacity("${productVO.capacity}");
	}	
</script>
<style>
.pic {
	...
	<br>
	 ...
	 <form:form id ="buyForm" method="post" action="cartAction" modelAttribute="productVO"> 
		 ...
		 <input type="hidden" id="pname" name="pname" size="15" value="${productVO.pname}">
	 	 ...
	 	 <input type="hidden" id="hardgrove" name="hardgrove" size="15" value="dutchCoffee">
