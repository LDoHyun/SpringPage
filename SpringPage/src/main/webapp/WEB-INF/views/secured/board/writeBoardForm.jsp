					...
					function($scope) {
						...
						$scope.formFinalCheck = function($event) {
							...
							if ($scope.boardForm.boardName.$valid == true
								...
								document.boardForm.action = "${pageContext.request.contextPath}/secured/board/writeBoardProc.do";
			...
			<table class="table table-striped">
				...
				<tr>
					...
					<td><input name="boardSub" type="text" id="boardSub"
						...
						title="글제목은 2~25자이내로 적습니다" ng-model="boardSub" ng-maxlength="25"
						ng-minlength="2" required="true" /></td>
				</tr>
				...
				<tr>
					...
					<td><textarea id="boardContent" name="boardContent" cols="40"
							rows="15" required="required" title="글내용은 2~1000자이내로 적습니다"
							class="form-control" ng-model="boardContent" ng-maxlength="1000"
							ng-minlength="2" required="true"></textarea></td>
				</tr>
