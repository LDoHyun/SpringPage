...
<script>
	...
	$("input:checkbox[name='chphone']:checked").val();
...
<br>
	...
	<nav id = "menu2">
		...
		<article>
			<h4>회원정보 수정</h4>
			<hr>
			<form:form modelAttribute="userUpdateVO" id="userview" name="userview" 
				...
				<div>
					...
					<input type="button" id="btnDelete" name="btnDelete" value="회원정보 삭제" ng-click="checkFinal()"
						   onclick="location.href='${pageContext.request.contextPath}/secured/user/userDelete?username=${userVO.username}'">
