...
/* $(document).ready(function(){
	$("#btn_delete").click(function(){
		if(confirm("삭제하시겠습니까?")){
			document.form1.action = "${pageContext.request.contextPath}/user/deleteAction"
	 ...
	 <c:forEach items="${users}" var="user" varStatus="st">
		 <tr>
             ...
             <input type="button" value="수정" id="btn_update" 
             		onclick="location.href='${pageContext.request.contextPath}/admin/user/userUpdate?username=${user.username}'"><br>
             <%-- <a href="${pageContext.request.contextPath}/user/deleteAction?username=${user.username}">삭제</a> --%>
             </td>
		 </tr>
	 </c:forEach> 
	</table>
