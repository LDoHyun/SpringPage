...
<!-------- paging 시작 -------->
 <div id="paging">
   ...
   <c:choose>
      ...
      <c:when test="${pnum <= pagingVO.rowPerPage}">
      ...
      <c:when test="${not empty pagingVO.curPage}">
         ...
         <!-- 처음 페이지 -->
   	     ...
   	     <li class="page-item">
   	     	<a class="page-link" href="${pageContext.request.contextPath}/admin/product/productlist?curPage=1">
		 ...
		 <!-- 이전 페이지 -->
		 <li class="page-item"> 
		 	<a class="page-link" href="${pageContext.request.contextPath}/admin/product/productlist?curPage=${pagingVO.prePage}">
		 		<span class="material-icons">
		 			skip_previous
		 		</span>
		 	</a>
         ...
         <!-- 시작/끝 페이지 설정 -->
	 	 ...
	 	 <c:set var="endNo" 
	 	 	    value="${pnum <= pagingVO.rowPerPage ? 1 : 5}"/> <!-- 3 페이지 단위 -->
      	 ...
      	 <c:choose>
       	 ...
       	 <c:set var="beginVar" 
       	 		value="${pnum > 10 && pagingVO.curPage == pagingVO.totPage ? 
       	 			     startNo-1 : startNo}" />
         ...
         <c:forEach begin="${beginVar}" 
			...
			<li class="active">
				<a class="page-link" href="${pageContext.request.contextPath}/admin/product/productlist?curPage=${st.index + pagingVO.curPage-2}">
         ...
         <!-- 다음 페이지 -->
		  <li class="page-item">
		  	<a class="page-link" href="${pageContext.request.contextPath}/admin/product/productlist?curPage=${pagingVO.nextPage}">
		  		<span class="material-icons">
   	     		   skip_next
	     		</span>
		  	</a>
		 ...
		 <!-- 마지막 페이지 -->
		 <li class="page-item">
		 	<a class="page-link" href="${pageContext.request.contextPath}/admin/product/productlist?curPage=${pagingVO.endPage}">
				<span class="material-icons">
   	     		   fast_forward
	     		</span> 
		 	</a>
